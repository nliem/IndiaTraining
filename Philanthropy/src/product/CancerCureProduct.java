 ...
 * Cancer Cure projects.
 * 
 * @author natalieliem
 *
 */
public class CancerCureProduct extends AbstractProduct implements Donatable {
   ...
   */
  public CancerCureProduct(int productId, String productName, String productDescription, String imagePath,
      double cost) {
