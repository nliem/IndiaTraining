 ...
 *
 */
public class OldAgeHomeProduct extends AbstractProduct implements Donatable {
   ...
   */
  public OldAgeHomeProduct(int productId, String productName, String productDescription, String imagePath,
      double cost) {
